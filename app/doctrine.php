...
//    $isDevMode = true;
//
//    //TODO Como tercer parámetro se podría pasar una caché
...
//    );
//    $namespaces = [
//        __DIR__ . '/../../src/Books/Entities/orm' => 'CoverfyApi\Books\Entities',
//    ];
...
//        'Books' => 'CoverfyApi\Books\Entities',
//    ]);
//
//    $conn = [
//        'driver' => 'pdo_pgsql',
...
//
//    if ($isDevMode) {
////        $configuration->setSQLLogger($c->get(\CoverfyApi\App\Utils\Doctrine\SqlLogger::class));
